...
<body>
    ...
    <header>
        <style>
            body {
                background: linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url("<?php echo Storage::disk('local')->url($cliente->url . '/' . $cliente->fundo); ?>");
                        ...
                        <div class="btnLinks">
                            ...
                            <div class="socialButtons">
                                ...
                                @if (!is_null($cliente->facebook))
                                    <a class="mb-4" href="https://{{ $cliente->facebook }}" role="button"
                                        rel="nofollow" target="_blank"><i class="fa-brands fa-facebook"
                                            style="color: {{ $cliente->button_color }}"></i></a>
                                @endif
